...
buildNoComing() => Get.bottomSheet(
      Padding(
        padding: const EdgeInsets.symmetric(vertical: 30, horizontal: 20),
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            SvgPicture.asset(RcAssets.icConnectionToAccount,
                color: primColor, height: 56),
            const SizedBox(height: 26),
            Text(
              "Votre compte n'est pas actif dans la communauté !\nVeuillez utiliser le lien d'invitation pour rejoindre.",
